...
public static  void deleteFiles(){
  ...
  for (File f : file.listFiles()){
   if(f.getName().startsWith("SumithraOutput")){
  f.delete();
  }
  }
 }
   // Map to KV pairs
  private static PCollection<KV<String, String>> sumithraMapper1(Pipeline p, String dataFolder, String dataFile) {
 ...
 // MAIN METHOD
  ...
  public static void main(String[] args) {
    ...
    PCollection<KV<String, String>> pCollection1 = sumithraMapper1(p, dataFolder, "go.md");
    PCollection<KV<String, String>> pCollection2 = sumithraMapper1(p, dataFolder, "java.md");
    PCollection<KV<String, String>> pCollection3 = sumithraMapper1(p, dataFolder, "python.md");
    PCollection<KV<String, String>> pCollection4 = sumithraMapper1(p, dataFolder, "README.md");
    // Make a List of PCs
    ...
    mergeString.apply(TextIO.write().to("SumithraOutput"));
