 ...
 * file service.
 */
public class MinimalPageRankPruthvi {
  ...
  PCollection<KV<String,String>> pCollList1 = PruthviMapper1(p,"go.md",folder);
   ...
   PCollection<KV<String,String>> pCollList5 = PruthviMapper1(p,"Axum.md",folder);
    ...
    p.run().waitUntilFinish();
        ...
        //pcollectionLinks.apply(TextIO.write().to("Pruthviout"));
  ...
  private static PCollection<KV<String, String>> PruthviMapper1(Pipeline p,String dataFile ,String dataFolder ) {
    String dataPath = dataFolder + "/" + dataFile;
    //p.apply(TextIO.read().from("gs://apache-beam-samples/shakespeare/kinglear.txt"))

    PCollection<String> pcollectionInputLines=p.apply(TextIO.read().from(dataPath));
      // .apply(Filter.by((String line) -> !line.isEmpty()))
      // .apply(Filter.by((String line)->!line.equals(" ")))
      PCollection<String> pcollectionLinkLines= pcollectionInputLines.apply(Filter.by((String line)->line.startsWith("[")));
      PCollection<String> pcollectionLinks=pcollectionLinkLines.apply(MapElements
      ...
      // from README.md to Key Value Pairs
        PCollection<KV<String,String>> pCollectionKeyValuePairs=pcollectionLinks.apply(MapElements
      ...
      .via(
       outlink->KV.of(dataFile,outlink)
           ...
           return pCollectionKeyValuePairs;
